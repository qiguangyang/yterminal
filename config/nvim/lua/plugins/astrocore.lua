  ...
  opts = {
    autocmds = {
      neotree_start = {
        {
          event = "VimEnter",
          desc = "When opening a directory, edit first file and show Neo-tree",
          callback = function()
      ...
      search_highlights = {
        {
          event = "ColorScheme",
          desc = "Override search highlights after colorscheme loads",
          callback = function()
            vim.api.nvim_set_hl(0, "Search", {
              bg = "#FFD700", fg = "#000000", bold = true, underline = true,
            })
            vim.api.nvim_set_hl(0, "CurSearch", {
              bg = "#FF5F00", fg = "#FFFFFF", bold = true, underline = true,standout = true,
            })
            vim.api.nvim_set_hl(0, "IncSearch", {
              bg = "#FF5F00", fg = "#FFFFFF", bold = true, underline = true,
            })
          end,
        },
      },
